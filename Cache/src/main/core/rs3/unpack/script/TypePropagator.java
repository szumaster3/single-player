package core.rs3.unpack.script;

import core.rs3.Unpack;
import core.rs3.unpack.ScriptTrigger;
...
import static core.rs3.unpack.script.Command.*;
...
public class TypePropagator {
    ...
    private sealed interface Node {
        ...
        record LocalType(int script, LocalDomain domain, int index) implements Node {}
