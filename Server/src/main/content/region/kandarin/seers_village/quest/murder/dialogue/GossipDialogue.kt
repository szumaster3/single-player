...
class GossipDialogueFile : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        when (getQuestStage(player!!, Quests.MURDER_MYSTERY)) {
            0 -> npcl("There's some kind of commotion up at the Sinclair place I hear. Not surprising all things considered.").also {
                stage = END_DIALOGUE
            }
            ...
            1 -> when (stage) {
                ...
                11 -> npcl("It's more cramped than his old place, but he seemed to like it. His children were furious at him for doing it though!").also {
                    stage = END_DIALOGUE
                }
                ...
                22 -> npcl("If his father ever found out, he would be in so much trouble... he might even get disowned!").also {
                    stage = END_DIALOGUE
                }
                ...
                26 -> npcl("kick him out of the house, as some of the servants have been there longer than he has, and he definitely has no right to treat them like he does... but I'm not one to gossip about people.").also {
                    stage = END_DIALOGUE
                }
                ...
                29 -> npcl("money. If his father ever found out, he would stop his income, and then he would be in serious trouble!").also {
                    stage = END_DIALOGUE
                }
                ...
                32 -> npcl("by killing all of the flowers in the garden. If her father ever found out she had done that he would be so furious he would probably disown her.").also {
                    stage = END_DIALOGUE
                }
                ...
                35 -> npcl("her father would be incredibly annoyed if he ever found out - he might even throw her out of the house!").also {
                    stage = END_DIALOGUE
                }
                ...
                39 -> npcl("If he ever found out that it was her who had stolen it he would go absolutely mental, maybe even disowning her!").also {
                    stage = END_DIALOGUE
                }
                ...
                41 -> npcl("Especially as I heard that the poison salesman in the Seers' village made a big sale to one of the family the other day.")
                    .also { setAttribute(player!!, MurderMystery.attributeNoiseClue, true) }
                    .also { stage = END_DIALOGUE }

                42 -> npcl("And I think you've been reading too many cheap detective novels. Hobbes is kind of uptight, but his loyalty to old Lord Sinclair is beyond question.").also {
                    stage = END_DIALOGUE
                }

                43 -> playerl("Think you could give me any hints?")
                    .also {
                        when (RandomFunction.random(4)) {
                            0 -> stage = 44
                            1 -> stage = 46
                            2 -> stage = 47
                            3 -> stage = 48
                ...
                45 -> npcl("the other day. I don't think he has any stock left now though...").also {
                    stage = END_DIALOGUE
                }

                46 -> npcl("Well, I don't know how much help this is, but I heard their guard dog will bark loudly at anyone it doesn't recognise. Maybe you should find out if anyone heard anything suspicious?").also {
                    stage = END_DIALOGUE
                }

                47 -> npcl("Well, this might be of some help to you. My father was in the guards when he was younger and he always said that there isn't a crime that can't be solved through careful examination of the crime scene and all surrounding areas.").also {
                    stage = END_DIALOGUE
                }
                ...
                50 -> npcl("I bet if you could find a way to get everyone's 'finger prints' you could solve the crime pretty easily!").also {
                    stage = END_DIALOGUE
                }
                ...
                52 -> npcl("Maybe you should try that? Don't forget to thank me if I help you solve the case!").also {
                    stage = END_DIALOGUE
                }
            }
        }
