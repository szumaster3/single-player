...
import content.region.kandarin.seers_village.quest.murder.attributeNoiseClue
import content.region.kandarin.seers_village.quest.murder.attributePoisonClue
import core.api.*
            ...
            1 -> when (stage) {
                ...
                2 -> showTopics(
                    ...
                    IfTopic(
                        ...
                        11,
                        getAttribute(player!!, attributePoisonClue, 0) > 0
                    )
                )
                ...
                4 -> npcl("She really hates me and was arguing with Lord Sinclair about trashing the garden a few days ago.").also {
                    stage = END_DIALOGUE
                }

                5 -> npcl("Right here, by my little shed. It's very cosy to sit and think in.").also {
                    stage = END_DIALOGUE
                }
                ...
                12 -> npcl("from that poison salesman the other day. I assume it was to sort out those bees. You'd really have to ask him though.").also {
                    stage = END_DIALOGUE
                }
            }
