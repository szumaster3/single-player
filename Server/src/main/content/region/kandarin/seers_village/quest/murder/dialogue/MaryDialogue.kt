    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (getQuestStage(player!!, Quests.MURDER_MYSTERY)) {
            ...
            1 -> when (stage) {
                ...
                4 -> npcl("I guess maybe him... but it's really scary to think someone here might have been responsible. I actually hope it was a burglar...").also {
                    stage = END_DIALOGUE
                }
                ...
                11 -> npcl("Oh that horrible dog is always barking at noting but I don't think I did...").also {
                    stage = END_DIALOGUE
                }
                ...
                13 -> npcl("She really doesn't get on well with Stanford, I really have no idea why. You'd really have to ask her though.").also {
                    stage = END_DIALOGUE
                }
            }
