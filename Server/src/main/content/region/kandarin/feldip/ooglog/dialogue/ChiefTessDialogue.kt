    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            34 -> when (buttonId) {
                ...
                2 -> playerl(FaceAnim.FRIENDLY, "Who are you and what's that thing on your head?").also {
                    stage = END_DIALOGUE
                }

                3 -> playerl(FaceAnim.FRIENDLY, "Do you know there's a larupia loose in this hut?").also {
                    stage = END_DIALOGUE
                }
