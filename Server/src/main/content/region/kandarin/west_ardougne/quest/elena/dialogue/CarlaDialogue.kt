...
class CarlaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npcl(FaceAnim.FRIENDLY, "It would be easier to cope with if I could have spent his last few days with him.").also { stage = 4 }
            4 -> playerl(FaceAnim.FRIENDLY, "Why didn't you?").also { stage++ }
            5 -> npcl(FaceAnim.SAD, "Those mourners came and whisked him away. He didn't even seem that ill, I thought it was a common cold. But the mourners said he was infected and had to be taken away. Two days later the mourners returned and told me he had died.").also { stage++ }
            ...
            9 -> npcl(FaceAnim.SAD, "It's down to King Tyras. He and his men brought the plague here from the darklands, and then left us to suffer. One day he'll pay for what he's done!").also { stage = 7 }
            10 -> npcl(FaceAnim.SAD, "You could say that... I've heard reports that half of West Ardougne is infected! Many have lost friends and family...").also { stage++ }
            11 -> playerl(FaceAnim.FRIENDLY, "It sounds an awful way to live.").also { stage++ }
            12 -> npcl(FaceAnim.FRIENDLY, "People are very depressed and scared. I've never met anyone fully infected though. I suppose we should be grateful to the mourners for that.").also { stage = END_DIALOGUE }
