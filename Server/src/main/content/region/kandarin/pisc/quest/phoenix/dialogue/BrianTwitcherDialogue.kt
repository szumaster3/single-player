 ...
 */
@Initializable
class BrianTwitcherDialogue : Dialogue {
    /**
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (stage) {
            ...
            2 -> {
                options("The phoenix.", "The ritual.", "The phoenix's lair.", "Going back inside.", "No more questions.")
                stage++
            }
    ...
    override fun getIds(): IntArray {
        return intArrayOf(NPCs.BRIAN_TWITCHER_8556)
    }
}
