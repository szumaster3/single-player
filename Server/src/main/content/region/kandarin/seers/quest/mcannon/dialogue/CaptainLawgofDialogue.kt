    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
            ...
            10 ->
                when (stage) {
                    0 -> {
                        if (content.region.kandarin.seers.quest.mcannon.DwarfCannon.allRailsFixed(player)) {
                            npc(
                                FaceAnim.OLD_NORMAL,
            ...
            20 ->
                when (stage) {
                    0 -> {
                        if (player.inventory.containsItem(content.region.kandarin.seers.quest.mcannon.DwarfCannon.DWARF_REMAINS)) {
                    ...
                    5 -> {
                        interpreter.sendItemMessage(
                            content.region.kandarin.seers.quest.mcannon.DwarfCannon.DWARF_REMAINS,
                    ...
                    10 -> {
                        ...
                        player.inventory.remove(content.region.kandarin.seers.quest.mcannon.DwarfCannon.DWARF_REMAINS)
            ...
            50 ->
                when (stage) {
                    ...
                    1 -> {
                        if (!player.hasItem(content.region.kandarin.seers.quest.mcannon.DwarfCannon.TOOL_KIT)) {
            ...
            80 ->
                when (stage) {
                    ...
                    2 ->
                        if (!player.inventory.containsItem(content.region.kandarin.seers.quest.mcannon.DwarfCannon.MOULD) ||
                            !player.inventory.containsItem(content.region.kandarin.seers.quest.mcannon.DwarfCannon.NULODION_NOTES)
                        ) {
