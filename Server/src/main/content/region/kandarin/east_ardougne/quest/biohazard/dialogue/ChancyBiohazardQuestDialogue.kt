 ...
 */
@Initializable
class ChancyBiohazardQuestDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun newInstance(player: Player?): Dialogue = ChancyBiohazardQuestDialogue(player)
