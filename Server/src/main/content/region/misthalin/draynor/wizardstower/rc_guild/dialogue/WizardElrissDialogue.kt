...
class WizardElrissDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            0 -> {
                showTopics(
                    IfTopic(text = "I've lost my omni-talisman.", toStage = 4, showCondition = !hasOmniTalisman && completeTask),
            ...
            54 -> npc("Ever since the Duke of Lumbridge sent the first air", "talisman to Sedridor, I have studied the talismans in", "great detail. I believe I can create a new form of", "talisman that combines the properties of all of them.").also { stage++ }
            55 -> npc("The omni-talisman will allow you to access any of the", "Runecrafting altars. It can be combined with a tiara or", "a staff, just like an ordinary talisman.").also { stage++ }
