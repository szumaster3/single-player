package content.region.misthalin.silvarea.quest.rag.dialogue
        ...
        when (getQuestStage(player!!, Quests.RAG_AND_BONE_MAN)) {
            0 -> {
                when (stage) {
                    ...
                    83 -> npcl(FaceAnim.FRIENDLY, "Anyway, I have enough problems of my own without dealing with a delusional adventurer.").also { stage = 16 }
                }
            }
            ...
            in 1..3 -> {
                when (stage) {
                    ...
                    3 -> npcl(FaceAnim.FRIENDLY, "Come and see me when you have the rest.").also { stage = END_DIALOGUE }
                    ...
                    32 -> npcl(FaceAnim.FRIENDLY, "Goblins are relatively common. I hear there is a house full of them around Lumbridge in fact.").also { stage = 40 }

                    41 -> npcl(FaceAnim.FRIENDLY, "You still need to bring me a Bear bone.").also { stage++ }
                    42 -> npcl(FaceAnim.FRIENDLY, "I heard that there are some Bears over by the Legends' Guild, near Ardougne.").also { stage = 50 }

                    51 -> npcl(FaceAnim.FRIENDLY, "You still need to bring me a Big Frog bone.").also { stage++ }
                    52 -> npcl(FaceAnim.FRIENDLY, "This might be a little tricky as you will need to go into the Lumbridge Swamp caves. You will need a light source! Never forget your light source down there!").also { stage = 60 }

                    61 -> npcl(FaceAnim.FRIENDLY, "You still need to bring me a Ram bone.").also { stage++ }
                    62 -> npcl(FaceAnim.FRIENDLY, "I'm sure you will be able to find a ram wherever there are sheep.").also { stage = 70 }

                    71 -> npcl(FaceAnim.FRIENDLY, "You still need to bring me a Unicorn bone.").also { stage++ }
                    72 -> npcl(FaceAnim.FRIENDLY, "I seem to remember that there were Unicorns south of Varrock, I think they might be there still.").also { stage = 80 }

                    81 -> npcl(FaceAnim.FRIENDLY, "You still need to bring me a Monkey bone.").also { stage++ }
                    82 -> npcl(FaceAnim.FRIENDLY, "Monkeys tend to live in Jungle areas, like Karamja. I think they are pretty plentiful there if I remember correctly.").also { stage = 90 }

                    91 -> npcl(FaceAnim.FRIENDLY, "You still need to bring me a Giant Rat bone.").also { stage++ }
                    92 -> npcl(FaceAnim.FRIENDLY, "If you can't find one in a sewer, then you might want to try looking in some caves.").also { stage = 100 }

                    101 -> npcl(FaceAnim.FRIENDLY, "You still need to bring me a Giant Bat bone.").also { stage++ }
                    102 -> npcl(FaceAnim.FRIENDLY, "Giant bats tend to live underground, but I have heard there are a few near the Coal Pits.").also { stage = 110 }
                    ...
                    114 -> npcl(FaceAnim.FRIENDLY, "Just chuck some logs into the pit, put the bone in the pot of vinegar and drop it onto the pot-boiler. Then light the logs and wait for the the vinegar to boil away.").also { stage++ }
