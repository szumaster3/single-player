    ...
    override fun run(entity: Entity): Boolean {
        if (entity is Player) {
            when (timerIdentifier) {
                DiamondOfSmokeListeners.timerIdentifierTorchNE -> sendMessage(
                    entity,
                    "The North-east torch burns out..."
                )

                DiamondOfSmokeListeners.timerIdentifierTorchSE -> sendMessage(
                    entity,
                    "The South-east torch burns out..."
                )

                DiamondOfSmokeListeners.timerIdentifierTorchSW -> sendMessage(
                    entity,
                    "The South-west torch burns out..."
                )

                DiamondOfSmokeListeners.timerIdentifierTorchNW -> sendMessage(
                    entity,
