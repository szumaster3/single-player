    ...
    override fun create(b: DialogueBuilder) {
        b.onQuestStages(Quests.DESERT_TREASURE, 0, 1, 2, 3, 4, 5, 6, 7, 8).playerl("Hello.")
            .npcl(FaceAnim.OLD_NORMAL, "You ssshould not be down here...").options().let { optionBuilder ->
                optionBuilder.option("Who are you?").playerl("Who are you?").npcl(
                    FaceAnim.OLD_NORMAL,
                    "My name isss unimportant... I live only to ssserve my massster.",
                ).playerl("Um... Okay then.").end()

                optionBuilder.option("Why are you down here?").playerl("Why are you down here?").npcl(
                    FaceAnim.OLD_NORMAL,
                ...
                ).playerl("Uh... Okay then.").end()

                optionBuilder.option("Can I use your anvil?").playerl("Can I use your anvil?").npcl(
                    FaceAnim.OLD_NORMAL,
                    "Of courssse you may... I have very little ussse for it nowadaysss...",
                ).playerl("Uh... Thanks, I guess.").end()
            }

        b.onQuestStages(Quests.DESERT_TREASURE, 9, 10, 100).playerl("Hello.")
            .npcl(FaceAnim.OLD_NORMAL, "You sshould not be down here...")
            .playerl("Are you an assistant to Count Draynor?")
            .npc(FaceAnim.OLD_NORMAL, "I usssed to have that honour...", "Why do you ssseek me?").branch { player ->
                ...
                branch.onValue(0).playerl(
                    "I understand that you can make me a 'sacrificial offering pot' if I bring you a bar of silver?",
                ).npcl(FaceAnim.OLD_NORMAL, "And where did you hear thisss?").playerl("It was from Malak in Canifis.")
                    .npc(
                        FaceAnim.OLD_NORMAL,
                        "Ah, I sssee...",
