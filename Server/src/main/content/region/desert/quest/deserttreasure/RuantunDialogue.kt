        ...
        b.onQuestStages(DesertTreasure.questName, 0, 1, 2, 3, 4, 5, 6, 7, 8)
            ...
            .let { optionBuilder ->
                optionBuilder.option("Who are you?")
                    .playerl("Who are you?")
                    .npcl(FaceAnim.OLD_NORMAL, "My name isss unimportant... I live only to ssserve my massster.")
                ...
                optionBuilder.option("Can I use your anvil?")
                    ...
                    .npcl(FaceAnim.OLD_NORMAL, "Of courssse you may... I have very little ussse for it nowadaysss...")
        ...
        b.onQuestStages(DesertTreasure.questName, 9, 10, 100)
            ...
            .branch { player ->
                ...
                branch.onValue(1)
                    ...
                    .npc(FaceAnim.OLD_NORMAL, "Yesss, of courssse...", "There you are, put it to good usssse...")
                    .end()
