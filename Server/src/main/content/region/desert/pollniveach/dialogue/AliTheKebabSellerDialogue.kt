...
class AliTheKebabSellerDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            8 -> npc("I offer two different types of kebabs: the standard", "run-of-the-mill kebab seen throughout Gielinor and", "enjoyed by many a intoxicated dwarf, and my specialty,", "the extra-hot kebab. So which shall it be?").also {
                stage++
            }
            ...
            53 -> npc("Shh! Keep your voice down. You should have told me you", "were from the union.").also {
                stage = 22
            }
