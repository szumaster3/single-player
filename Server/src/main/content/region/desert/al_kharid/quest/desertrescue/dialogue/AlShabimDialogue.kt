package content.region.desert.al_kharid.quest.desertrescue.dialogue
            ...
            54 -> when (stage) {
                ...
                23 -> {
                    interpreter.sendItemMessage(
                        TouristTrap.TECHNICAL_PLANS, "You hand over the technical plans for the weapon."
                    )
                    stage++
                }
                ...
                29 -> {
                    ...
                    interpreter.sendItemMessage(
                        806, "<col=08088A>*** Dart Construction ***", "Congratulations! You can now construct darts."
                    )
                    stage++
                }
            }
