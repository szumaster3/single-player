package content.region.desert.al_kharid.quest.desertrescue.npc
...
class RowdySlaveNPC : AbstractNPC {
    ...
    override fun construct(id: Int, location: Location, vararg objects: Any): AbstractNPC = RowdySlaveNPC(id, location)
