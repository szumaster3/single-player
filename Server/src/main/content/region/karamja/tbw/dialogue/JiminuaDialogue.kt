...
class JiminuaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            4 -> npc("I'm glad you ask! You can buy as many of the items", "stocked as you wish. You can also sell most items", "to the shop.").also { stage = END_DIALOGUE }
            5 -> npc("I can un-note pure essence, but nothing else. Just", "give me the notes you wish to exchange.").also { stage = END_DIALOGUE }
        }
        return true
    }
