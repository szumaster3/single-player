...
import content.minigame.pest_control.plugin.PestControlSession
...
class PCPortalNPC(id: Int = NPCs.PORTAL_6142, l: Location? = null) : AbstractNPC(id, l) {
    ...
    private val difficultyIndex: Int
        get() {
            if (id > 7550) {
                return 2
            }
