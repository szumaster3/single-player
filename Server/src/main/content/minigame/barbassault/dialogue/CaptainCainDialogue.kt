...
class CaptainCainDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            6 -> npcl(FaceAnim.FRIENDLY, "Better. Now what is a low-life, pathetic excuse for a human being doing sniffing around my arena?").also { stage++ }
            7 -> playerl(FaceAnim.FRIENDLY, "Exploring, captain. Looked like a chance for combat, sir!").also { stage++ }
            8 -> npcl(FaceAnim.FRIENDLY, "And you think you have what is necessary to take on the Penance? No chance.").also { stage++ }
            9 -> playerl(FaceAnim.FRIENDLY, "With respect, captain, I don't understand what this place is.").also { stage++ }
            10 -> npcl(FaceAnim.FRIENDLY, "You really are useless, aren't you? Very well, make the most of this because I don't suffer idiots easily! This is the Barbarian Assault arena. You want to sign up with us?").also { stage++ }
