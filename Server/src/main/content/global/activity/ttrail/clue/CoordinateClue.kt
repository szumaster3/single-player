 ...
 * @author Vexia
 */
class CoordinateClue(name: String? = null, clueId: Int = -1, level: ClueLevel? = null, location: Location? = null, clue: String? = null) : CoordinateScroll(name, clueId, level, location, clue) {
