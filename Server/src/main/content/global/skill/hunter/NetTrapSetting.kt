...
class NetTrapSetting : TrapSetting(
    ...
    override fun reward(player: Player, node: Node, wrapper: TrapWrapper) {
        ...
        var secondary: core.game.node.scenery.Scenery? = core.game.node.scenery.Scenery(
            wrapper.netType.net,
    ...
    override fun getTransformId(wrapper: TrapWrapper?, node: TrapNode?): Int = wrapper!!.netType.catching

    override fun getFinalId(wrapper: TrapWrapper, node: TrapNode): Int = wrapper.netType.caught

    override fun getFailId(wrapper: TrapWrapper, node: TrapNode): Int = wrapper.netType.failing
    ...
    enum class NetTrap(val original: Int, @JvmField val bent: Int, val failing: Int, @JvmField val failed: Int, val catching: Int, @JvmField val caught: Int, @JvmField val net: Int) {
        ...
        BLACK(Scenery.YOUNG_TREE_19671, Scenery.YOUNG_TREE_19670, Scenery.NET_TRAP_19668, Scenery.NET_TRAP_19669, Scenery.NET_TRAP_19666, Scenery.NET_TRAP_19667, Scenery.NET_TRAP_19681), ;
