...
class ImplingJarPlugin : InteractionListener {
    ...
    /**
     * Represents all impling jar item ids that can be interacted with.
     */
    private val IMPLING_JAR_ITEM_IDS = ImplingLoot.values().map { it.jarId }.toIntArray()

    override fun defineListeners() {
        on(IMPLING_JAR_ITEM_IDS, IntType.ITEM, "loot") { player, node ->
            val jar = node.asItem()
    ...
    /**
     * Represents the types of impling jars and their loot tables.
     *
     * @property jarId the item ids of the jar.
     * @property table the weighted loot table for the jar.
     */
    private enum class ImplingLoot(val jarId: Int, val table: WeightBasedTable) {
        BABY_IMPLING(
        ...
        companion object {
             ...
             * Map of jar ids.
             */
            private val jarMap = HashMap<Int, WeightBasedTable>()
            ...
            /**
             * Gets the weighted loot table for a given jar id.
             *
             * @param id the item id of the impling jar
             * @return the loot table for the jar.
             */
