...
class WerewolfGuardDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            2 -> npcl(FaceAnim.CHILD_NORMAL, "If it wasn't my duty to stand here and guard our agility course from the likes of you, I would be relieving you of your life right now.").also { stage++ }
            3 -> playerl(FaceAnim.HALF_GUILTY, "So it's an agility course, then?").also { stage++ }
            4 -> npcl(FaceAnim.CHILD_NORMAL, "No ... yes ... oh blast - you didn't hear me say anything, right?").also { stage++ }
