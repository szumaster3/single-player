...
public final class Cache {
	...
	/**
	 * Method used to return the render animation definition size.
	 *
	 * @return the size.
	 */
	public static int getRenderAnimationDefinitionsSize() {
		CacheFileManager manager = getIndexes()[2];
		return manager != null ? manager.getFilesSize(32) : 0;
	}
}